...
export const Route = createFileRoute("/_app/empresas")({
  head: () => ({
    meta: [
      { title: "Empresas (CNPJs) — Gestão de RH" },
      { name: "description", content: "Cadastro e controle de empresas e seus CNPJs." },
    ],
  }),
  component: Building2Page,
});

function Building2Page() {
  const { canDelete } = useAuth();
  return (
    <PageShell
      title="Empresas (CNPJs)"
      description="Cadastro e controle de empresas e seus CNPJs."
