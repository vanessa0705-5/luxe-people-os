...
export const Route = createFileRoute("/_app/ferias")({
  head: () => ({
    meta: [
      { title: "Férias — Gestão de RH" },
      { name: "description", content: "Controle de férias e programação anual." },
    ],
  }),
  component: PalmtreePage,
});

function PalmtreePage() {
  const { canDelete } = useAuth();
  return (
    <PageShell
      title="Férias"
      description="Controle de férias e programação anual."
