...
export const Route = createFileRoute("/_app/movimentacoes")({
  head: () => ({
    meta: [
      { title: "Movimentações — Gestão de RH" },
      { name: "description", content: "Registro de movimentações internas e transferências." },
    ],
  }),
...
function RepeatPage() {
  ...
  return (
    <PageShell
      title="Movimentações"
      description="Registro de movimentações internas e transferências."
