...
export const Route = createFileRoute("/_app/administracao")({
  head: () => ({
    meta: [
      { title: "Administração — Gestão de RH" },
      { name: "description", content: "Configurações administrativas e usuários do sistema." },
    ],
  }),
...
function SettingsPage() {
  ...
  return (
    <PageShell
      title="Administração"
      description="Configurações administrativas e usuários do sistema."
      icon={<Settings className="h-5 w-5 text-gold-foreground" />}
      actions={
        <>
