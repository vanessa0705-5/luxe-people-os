    ...
    <Sidebar collapsible="icon" className="border-r border-sidebar-border">
      <SidebarHeader className="border-b border-sidebar-border p-4">
        <div className="flex items-center gap-3">
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md bg-gradient-gold font-bold text-sm shadow-gold">
            RH
          </div>
          {!collapsed && (
            <div className="flex flex-col leading-tight">
              <span className="text-sm font-semibold text-sidebar-foreground">Gestão de RH</span>
              <span className="text-[10px] uppercase tracking-wider text-gold">Sistema Interno</span>
            </div>
          )}
        </div>
      </SidebarHeader>
      ...
      <SidebarFooter className="border-t border-sidebar-border p-3">
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={() => signOut()}
            className="rounded-md p-1.5 text-sidebar-foreground/70 hover:bg-sidebar-accent hover:text-gold transition-colors"
            title="Sair"
          >
