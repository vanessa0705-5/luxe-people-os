...
import { z } from "zod";
const gw = createOpenAICompatible({ name: "lovable", baseURL: "https://ai.gateway.lovable.dev/v1", headers: { "Lovable-API-Key": process.env.LOVABLE_API_KEY!, "X-Lovable-AIG-SDK": "vercel-ai-sdk" }, supportsStructuredOutputs: true });
const r = streamText({
